...
const FALLBACK_QUESTIONS = [
  { theme: 'pop', question: "Dans quel manga le personnage Naruto Uzumaki est-il le héros principal ?", type: 'qcm', options: ['One Piece', 'Naruto', 'Bleach', 'Dragon Ball'], answer: 'Naruto', explanation: "Naruto est le ninja héros de la série éponyme de Masashi Kishimoto.", difficulty: 'facile' },
  { theme: 'tech', question: "TikTok a été développé par la société chinoise ByteDance.", type: 'vf', options: ['Vrai', 'Faux'], answer: 'Vrai', explanation: "TikTok est effectivement une application de ByteDance, fondée en 2012.", difficulty: 'facile' },
  { theme: 'sport', question: "Quel joueur détient le record du plus grand nombre de Ballons d'Or ?", type: 'qcm', options: ['Cristiano Ronaldo', 'Lionel Messi', 'Ronaldinho', 'Zinédine Zidane'], answer: 'Lionel Messi', explanation: "Messi a remporté 8 Ballons d'Or, record historique.", difficulty: 'moyen' },
  { theme: 'music', question: "L'afrobeat a été popularisé par le nigérian Fela Kuti dans les années 70.", type: 'vf', options: ['Vrai', 'Faux'], answer: 'Vrai', explanation: "Fela Kuti est considéré comme le père de l'afrobeat.", difficulty: 'moyen' },
  { theme: 'tech', question: "Quel modèle d'IA a été développé par OpenAI ?", type: 'qcm', options: ['Gemini', 'Claude', 'GPT-4', 'Llama'], answer: 'GPT-4', explanation: "GPT-4 est le modèle phare d'OpenAI, sorti en 2023.", difficulty: 'facile' },
  { theme: 'pop', question: 'Dans quel pays se déroule la série Netflix "Squid Game" ?', type: 'qcm', options: ['Japon', 'Chine', 'Corée du Sud', 'Thaïlande'], answer: 'Corée du Sud', explanation: "Squid Game est une série sud-coréenne devenue phénomène mondial.", difficulty: 'facile' },
  { theme: 'sport', question: "Les jeux olympiques de Paris 2024 se sont tenus pour la 3ème fois en France.", type: 'vf', options: ['Vrai', 'Faux'], answer: 'Vrai', explanation: "Paris avait déjà accueilli les JO en 1900 et 1924.", difficulty: 'difficile' },
  { theme: 'music', question: 'Quel artiste a popularisé l\'expression "Drip" dans la culture rap ?', type: 'qcm', options: ['Drake', 'Future', 'Lil Uzi Vert', 'Young Thug'], answer: 'Future', explanation: "Future est l'un des pionniers du drip et du trap moderne.", difficulty: 'difficile' },
  { theme: 'tech', question: "Instagram a été racheté par Facebook (Meta) en 2012 pour 1 milliard de dollars.", type: 'vf', options: ['Vrai', 'Faux'], answer: 'Vrai', explanation: "Ce rachat est l'un des plus célèbres de l'histoire de la tech.", difficulty: 'moyen' },
  { theme: 'pop', question: "Quel jeu vidéo détient le record du plus grand nombre de joueurs simultanés sur Steam ?", type: 'qcm', options: ['CS:GO', 'PUBG', 'Cyberpunk 2077', 'Elden Ring'], answer: 'PUBG', explanation: "PUBG a établi le record avec plus de 3 millions de joueurs simultanés en 2018.", difficulty: 'difficile' },
]
...
export default function App() {
  ...
  const [loadingMsg, setLoadingMsg] = useState("Génération des questions avec l'IA...")
  ...
  async function startQuiz() {
    setScreen('loading')
    const msgs = ["Génération des questions avec l'IA...", 'Mélange des thèmes...', 'Calibrage des niveaux...']
    let mi = 0
  ...
  return (
    <div style={{ maxWidth: 480, margin: '0 auto', padding: '24px 16px' }}>
      ...
      {screen === 'loading' && <LoadingScreen text={loadingMsg} />}
    ...
    <div>
      <div style={{ textAlign: 'center', padding: '32px 16px' }}>
        ...
        <p style={{ fontSize: 15, color: '#666', marginTop: 8 }}>
          10 questions · 4 thèmes · niveaux mixtes
        </p>
      </div>
